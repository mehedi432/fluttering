                    ...
                    child: Container(
                      ...
                      child: Center(
                        child: Text(
                          'সূরা',
                          style: TextStyle(
                              fontWeight: FontWeight.w500, fontSize: 21, letterSpacing: 1.6),
                        ),
                      ),
                    ),
                  ),
                    ...
                    child: Container(
                      ...
                      child: Center(
                        child: Text(
                          'সর্বশেষ পঠিত',
                          style: TextStyle(
                              fontWeight: FontWeight.w900, fontSize: 21, letterSpacing: 1.6),
                        ),
                      ),
                    ),
                  ),
      ...
      child: InkWell(
        ...
        child: Container(
          ...
          child: Center(
            child: Text(
              'নোট রাখুন',
              style: TextStyle(fontWeight: FontWeight.w500, fontSize: 21, letterSpacing: 1.6),
            ),
          ),
        ),
      ),
